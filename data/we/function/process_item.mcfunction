...
$execute store result score #cnt bc_temp run data get block 172 76 -74 Items[{id:"$(item)"}].Count
...
$execute if score #cnt bc_temp matches 1.. run data remove block 172 76 -74 Items[{id:"$(item)"}]
