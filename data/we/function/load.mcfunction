...
scoreboard objectives add we_item_display_2 dummy {text:"Forge Pg. 2", color:aqua, bold:true}
scoreboard objectives add we_stats dummy {text: "Forge Stats", color:green, bold:true}
scoreboard objectives add world dummy "World Score"
scoreboard objectives add temp dummy
scoreboard objectives add forge_timer dummy
scoreboard players set three temp 3
scoreboard players set hundred temp 100
