...
scoreboard players display name progress we_stats [{"text":"Power required: ","color":"gray"},{"score":{"name":"progress","objective":"temp"},"color":"gold","bold":true}]
scoreboard players display name level we_stats [{"text":"Current Level: ","color":"gray"},{"score":{"name":"WorldLevel","objective":"world"},"color":"green","bold":true}]
# we_stats also has msg and msg 1 etc. 
